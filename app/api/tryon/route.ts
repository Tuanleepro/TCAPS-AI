...
const TRYON_PROMPT =
  ...
  'RULE 2 — USE THE EXACT CAP FROM THE PRODUCT IMAGE(S): images 2 and onward are the SAME cap shown ' +
  'from different angles (front / side / back / detail). Study ALL of them together and reproduce the ' +
  'cap exactly — its real shape, colours, brim and crown, and ESPECIALLY the exact logo / text / ' +
  'graphic / pattern. Do not redesign, recolour, re-letter or substitute the artwork. ' +
